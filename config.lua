...
Config.DefaultInfo = {
    ...
    defaultRole = "🛵 Member", -- Default role display for players with no Discord roles
...
Config.QueueUpdateRate = 2000 -- How often to update queue in milliseconds (2 seconds recommended)
...
Config.QueueTimePoints = {
    ...
    intervalSeconds = 30 -- Award points every 30 seconds of waiting
}
...
Config.Discord = {
    ...
    roles = {
        ...
        ["678901234567890123"] = { name = "🛵 Member", points = 10 }
    }
}
